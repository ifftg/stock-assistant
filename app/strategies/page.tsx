        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:border-blue-400/50 transition-all duration-300">
            <div className="text-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-white">停机坪策略</h3>
            </div>
            <div className="space-y-2 mb-6">
              <div className="text-gray-300">• 15日内涨幅 > 9.5%</div>
              <div className="text-gray-300">• 后续3日高开收涨</div>
              <div className="text-gray-300">• 横盘整理形态</div>
            </div>
            <div className="text-center mb-4">
              <div className="text-2xl font-bold text-green-400">12只</div>
              <div className="text-sm text-gray-400">符合条件股票</div>
            </div>
            <button className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl">
              开始筛选
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:border-blue-400/50 transition-all duration-300">
            <div className="text-center mb-4">
              <div className="text-4xl mb-2">🐢</div>
              <h3 className="text-xl font-semibold text-white">海龟交易法则</h3>
            </div>
            <div className="space-y-2 mb-6">
              <div className="text-gray-300">• 突破60日最高价</div>
              <div className="text-gray-300">• 成交量放大</div>
              <div className="text-gray-300">• 趋势确认信号</div>
            </div>
            <div className="text-center mb-4">
              <div className="text-2xl font-bold text-green-400">34只</div>
              <div className="text-sm text-gray-400">符合条件股票</div>
            </div>
            <button className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl">
              开始筛选
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:border-blue-400/50 transition-all duration-300">
            <div className="text-center mb-4">
              <div className="text-4xl mb-2">📋</div>
              <h3 className="text-xl font-semibold text-white">基本面选股</h3>
            </div>
            <div className="space-y-2 mb-6">
              <div className="text-gray-300">• PE ≤ 20 且 > 0</div>
              <div className="text-gray-300">• PB ≤ 10</div>
              <div className="text-gray-300">• ROE ≥ 15%</div>
            </div>
            <div className="text-center mb-4">
              <div className="text-2xl font-bold text-green-400">89只</div>
              <div className="text-sm text-gray-400">符合条件股票</div>
            </div>
            <button className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl">
              开始筛选
